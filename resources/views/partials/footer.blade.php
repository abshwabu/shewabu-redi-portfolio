    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                ...
                <p class="mt-4 max-w-sm text-sm leading-relaxed text-primary-100">
                    Professional audit, taxation, accounting, and advisory services delivered with integrity and regulatory excellence.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2.5 text-sm">
                    <li><a href="{{ route('services.audit') }}" class="text-primary-100 transition-colors hover:text-accent">External Audit</a></li>
                    <li><a href="{{ route('services.taxation') }}" class="text-primary-100 transition-colors hover:text-accent">Taxation</a></li>
                    <li><a href="{{ route('services.accounting') }}" class="text-primary-100 transition-colors hover:text-accent">Accounting &amp; Bookkeeping</a></li>
                    <li><a href="{{ route('services.advisory') }}" class="text-primary-100 transition-colors hover:text-accent">Business Advisory</a></li>
                    <li><a href="{{ route('services.assurance') }}" class="text-primary-100 transition-colors hover:text-accent">Assurance &amp; Compliance</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3 text-sm text-primary-100">
                    ...
                    <li class="flex gap-3">
                        ...
                        <a href="tel:+251XXXXXXXXX" class="transition-colors hover:text-accent">+251 XX XXX XXXX</a>
                    </li>
                    <li class="flex gap-3">
                        <svg class="mt-0.5 h-4 w-4 shrink-0 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </svg>
                        <a href="mailto:info@shewaburedi.com" class="transition-colors hover:text-accent">info@shewaburedi.com</a>
                    </li>
                </ul>

                <div class="mt-6 flex items-center gap-3">
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center border border-primary-600 text-primary-100 transition-colors hover:border-accent hover:text-accent" aria-label="LinkedIn">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center border border-primary-600 text-primary-100 transition-colors hover:border-accent hover:text-accent" aria-label="Facebook">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="#" class="inline-flex h-9 w-9 items-center justify-center border border-primary-600 text-primary-100 transition-colors hover:border-accent hover:text-accent" aria-label="X (Twitter)">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.727-8.835L1.254 2.25H8.08l4.251 5.632 5.913-5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                </div>
            </div>
        ...
        <div class="mt-12 flex flex-col gap-4 border-t border-primary-700 pt-8 sm:flex-row sm:items-center sm:justify-between">
            <p class="text-xs text-primary-200">
                &copy; {{ date('Y') }} Shewabu Redi Mohammed Authorized Accounting Firm. All rights reserved.
            </p>
