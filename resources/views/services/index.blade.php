...
@section('content')
    <section class="relative overflow-hidden bg-primary text-surface-50">
        ...
        <div class="section-shell relative py-16 sm:py-20">
            <p class="eyebrow text-accent-200">Capabilities</p>
            <h1 class="mt-4 font-display text-4xl font-bold sm:text-5xl">Our Services</h1>
            <p class="mt-5 max-w-2xl text-base leading-relaxed text-primary-100 sm:text-lg">
                End-to-end professional services for organisations that need reliable compliance and insightful financial support.
            </p>
        </div>
    </section>
    ...
    <section class="section-pad bg-surface-50">
        <div class="section-shell grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
                <p class="text-surface-600 sm:col-span-2 lg:col-span-3">No published services yet.</p>
            @endforelse
        </div>
    </section>
@endsection
