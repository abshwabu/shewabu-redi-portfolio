...
class DatabaseSeeder extends Seeder
{
    ...
    protected function seedSettings(): void
    {
        SiteSetting::current()->update([
            ...
            'about_excerpt' => 'We are an authorized accounting firm serving clients across Ethiopia with integrity, regulatory excellence, and practical financial guidance.',
